...
public class WindowsStartupTests
{
    ...
    {
        var running = @"C:\Users\jane\AppData\Local\Greenlight.BlameClient\current\Greenlight.BlameClient.exe";
        var shim = @"C:\Users\jane\AppData\Local\Greenlight.BlameClient\Greenlight.BlameClient.exe";
    ...
    public void A_folder_merely_called_current_is_not_a_promise()
    {
        ...
        var running = @"D:\stuff\current\Greenlight.BlameClient.exe";
    ...
    {
        var running = @"C:\src\blame\bin\Release\net10.0-windows\Greenlight.BlameClient.exe";
