...
/// <summary>
/// Whether the notice is watching again when Windows comes back. One value under the current user's
...
/// <c>blame.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
/// ordinary thing to meet, and an app that fell over because it could not offer to start
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Blame";
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.BlameClient\current\Greenlight.BlameClient.exe</c>,
